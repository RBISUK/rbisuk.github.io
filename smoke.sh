...
err=0
# must-have
for f in index.html demo.html careers.html legal.html managed.html articles/body-lounge.html; do
...
for f in index.html demo.html careers.html legal.html managed.html; do
