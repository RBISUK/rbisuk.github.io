export const metadata={title:"Housing Association Repairs Complaint | Housing Disrepair FAQ"};
export default function Page(){return(<main className="mx-auto max-w-3xl px-4 py-10">
<h1 className="text-3xl font-bold">Housing Association Repairs Complaint</h1>
