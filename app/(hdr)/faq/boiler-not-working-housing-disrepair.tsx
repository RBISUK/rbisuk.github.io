export const metadata={title:"Boiler Not Working Housing Disrepair | Housing Disrepair FAQ"};
export default function Page(){return(<main className="mx-auto max-w-3xl px-4 py-10">
<h1 className="text-3xl font-bold">Boiler Not Working Housing Disrepair</h1>
