export default function ExpressPricing({ content }: { content: any }) {
  ...
  return (
    <section aria-labelledby="express-title" className="container py-12">
      <h2 id="express-title" className="text-2xl sm:text-3xl font-bold text-center">
        One Price. One Day. One System Nobody Else Can Match.
      </h2>
      <div className="card mt-6">
        <div className="p-6 sm:p-8 text-center bg-white">
          ...
          <div className="mt-6">
            <a href="/contact" className="btn-primary w-full sm:w-auto">Book My 24h Build</a>
          </div>
        </div>
      </div>
    </section>
